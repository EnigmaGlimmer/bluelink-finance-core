...
const Presale = () => {
  ...
  return (
    <section
      id="presale"
      className="py-20 bg-gradient-to-br from-sky-100 via-sky-50 to-white relative overflow-hidden"
    >
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="text-center bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-sky-200 animate-fade-in shadow-lg hover:shadow-xl transition-all duration-300"
