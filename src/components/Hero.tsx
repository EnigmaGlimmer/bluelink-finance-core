...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 bg-gradient-to-br from-sky-50 via-sky-100 to-sky-200">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <div className="mb-8 animate-fade-in delay-200">
          <p className="text-xl md:text-2xl font-semibold text-blue-700 mb-2">
            "<span className="text-blue-600 font-bold">Today's Success</span>, <span className="text-sky-600 font-bold">Tomorrow's Solution</span>"
          </p>
        </div>

        {/* Professional Subtitle */}
        <p className="text-lg md:text-xl mb-12 max-w-4xl mx-auto text-gray-700 animate-fade-in delay-300 leading-relaxed">
          <span className="text-blue-600 font-semibold">BlueLink Blockchain Services </span> presents a regulated ecosystem combining exchange operations, 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-8 border border-sky-200 animate-fade-in hover:bg-white/80 transition-all duration-300 hover:transform hover:scale-105 shadow-lg">
            ...
            <div className="text-sm text-gray-600 uppercase tracking-wider">Target Raise</div>
          </div>
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-8 border border-sky-200 animate-fade-in hover:bg-white/80 transition-all duration-300 hover:transform hover:scale-105 shadow-lg">
            <Shield className="h-10 w-10 mx-auto mb-4 text-emerald-500" />
            <div className="text-3xl font-bold text-gray-900 mb-2">Regulated</div>
            <div className="text-sm text-gray-600 uppercase tracking-wider">Dubai & BVI</div>
          </div>
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-8 border border-sky-200 animate-fade-in hover:bg-white/80 transition-all duration-300 hover:transform hover:scale-105 shadow-lg">
            <Globe className="h-10 w-10 mx-auto mb-4 text-sky-500" />
            <div className="text-3xl font-bold text-gray-900 mb-2">Welcome</div>
            <div className="text-sm text-gray-600 uppercase tracking-wider">Early Investors</div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in delay-1000">
          ...
          <a 
            ...
            download
            className="inline-flex items-center bg-white justify-center border-2 border-blue-200 text-blue-700 hover:bg-blue-50 px-10 py-4 text-lg font-semibold rounded-xl backdrop-blur-sm transition-all duration-300 hover:border-blue-300 shadow-md"
          >
            Whitepaper
